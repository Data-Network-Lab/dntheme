...
#' dn ggplot theme
#'
#' This ggplot theme implements the dn chart style. The theme
...
#' Then use the \code{add_dn_titles} function to add the title and subtitle
#' elements. Using \code{add_dn_titles} also has the benefit of correctly
...
#' of the title and subtitle in \code{add_dn_titles} if you need to change
...
theme_dn <- function (
  ...
  title_family = getOption("dn.title_family"),
  subtitle_family =getOption("dn.subtitle_family"),
  axis_title_family = getOption("dn.axis_title_family"),
  axis_text_family = getOption("dn.axis_text_family"),
  legend_title_family = getOption("dn.legend_title_family"),
  legend_text_family = getOption("dn.legend_text_family"),
  facet_title_family = getOption("dn.facet_title_family"),
  caption_family = getOption("dn.caption_family"),
  title_size = 17,
  subtitle_size = 12,
  axis_title_size = 11,
  axis_text_size = 11,
...
#'
#' Use this function to add titles to a plot that uses \code{theme_dn}.
...
#'
#' To use the function, first create a plot using \code{theme_dn}
#' without setting the title or subtitle, capturing the plot object in a
#' variable. Pass the plot to \code{add_dn_titles} along with the title
...
add_dn_titles <- function(
  ...
  theme_titles <- theme_dn() + ggplot2::theme(
